...
const ProductPage = ({ data }) => {
  const item = () => {
    return data.filter((item) => (item.id === "1" ? { item } : false));
  };
  const product = item();
  console.log(product);
  return (
    ...
    <div>
      ...
      <div className={styles.overall}>
        ...
        <div>
          <img
            src="https://images-na.ssl-images-amazon.com/images/I/51zyIctEERL._SX679_.jpg"
            alt=""
        ...
        <div className={styles.thrddiv}>
          <h4 className={styles.title}>
            Ss Arts Engineered Wood Wall Mount WiFi Router Stand/Rack{" "}
          </h4>
        ...
        <div>
          <div className={styles.fir}>{/* <a  className="ab">Share</a> */}</div>
